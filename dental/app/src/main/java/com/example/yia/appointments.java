...
public class appointments extends ActionBarActivity {TextView tv_clientfullnames, tv_clientemail;
    Spinner spinnerOne;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listViewOne.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,
                ...
                clsGlobal.investmentid = ((TextView) view.findViewById(R.id.tv_investmentid)).getText().toString();
                //finish();
                Intent intent = new Intent(appointments.this, Investmentdetails.class);
    ...
    class Loadinvestmentdepartments extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
            ...
            if (count > 0) {
                ArrayAdapter<String> dtpAdapter = new ArrayAdapter<String>(appointments.this, android.R.layout.simple_spinner_item, allDepartments);
